                ...
                .addOnCompleteListener(this, new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Snackbar snackBar = Snackbar.make(findViewById(R.id.activity_forgot_password), "We have sent a recovery email.", Snackbar.LENGTH_SHORT);
                            snackBar.show();
                        }
                        else
                            {
                            Snackbar snackBar = Snackbar.make(findViewById(R.id.activity_forgot_password), "Recovery Failed.", Snackbar.LENGTH_SHORT);
                            snackBar.show();
                        }
                    }
                });
